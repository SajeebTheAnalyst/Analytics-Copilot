...
3. **Automate Weekly MIS Snapshots**: Archive weekly report snapshots to track period-over-period variance trends.`;
  ...
  return (
    <div className="flex-1 flex flex-col h-full overflow-hidden bg-zinc-50/50 dark:bg-[#050505]">
      ...
      <div className="no-print bg-white dark:bg-zinc-950 border-b border-zinc-200 dark:border-zinc-800 p-4 sm:p-6 shrink-0 space-y-4">
        ...
        {isConfigExpanded && (
          <div className="pt-4 border-t border-zinc-100 dark:border-zinc-900 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 text-xs bg-zinc-50 dark:bg-zinc-900/60 p-4 rounded-xl border border-zinc-200/80 dark:border-zinc-800">
      ...
      {primaryDataset && (
        <div className="no-print bg-white dark:bg-zinc-950 border-b border-zinc-200 dark:border-zinc-800 px-6 py-2.5 flex flex-wrap items-center gap-3 shrink-0">
      ...
      <div className="flex-1 overflow-y-auto p-4 sm:p-8 custom-scrollbar">
        {!reportData ? (
          ...
          <div className="printable-report max-w-5xl mx-auto bg-white dark:bg-zinc-950 p-8 sm:p-12 rounded-xl border border-zinc-200 dark:border-zinc-800 shadow-md text-zinc-900 dark:text-zinc-100 space-y-10">
