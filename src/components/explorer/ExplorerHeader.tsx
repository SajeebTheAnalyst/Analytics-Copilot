...
export function ExplorerHeader({
  ...
  return (
    <div className="glass-panel border-b border-zinc-200 dark:border-zinc-800 px-6 py-4 shrink-0 shadow-xs">
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 max-w-full">
        ...
        <div className="flex items-start gap-4">
          <div className="w-10 h-10 rounded-xl bg-blue-50 dark:bg-blue-950/50 border border-blue-200 dark:border-blue-900/50 flex items-center justify-center shrink-0 text-blue-600 dark:text-blue-400 mt-0.5 shadow-sm">
          ...
          <div>
            <div className="flex items-center gap-3 flex-wrap">
              ...
              {allDatasets.length > 1 && onSelectDataset ? (
                <select
                  ...
                  className="text-xs font-medium bg-zinc-100/80 dark:bg-zinc-800/80 text-zinc-800 dark:text-zinc-200 border border-zinc-200/80 dark:border-zinc-700/80 rounded-lg px-2.5 py-1 focus:outline-none focus:ring-2 focus:ring-blue-500/20 hover-elevate cursor-pointer shadow-3xs"
                >
                  {allDatasets.map((d) => (
                ...
                <span className="px-2.5 py-0.5 rounded-md text-xs font-semibold bg-zinc-100 dark:bg-zinc-800 text-zinc-700 dark:text-zinc-300 border border-zinc-200/80 dark:border-zinc-700/80 hover-elevate cursor-default">
                  {dataset.name}
                </span>
              )}
            ...
            <div className="flex items-center gap-3 mt-2 text-xs text-zinc-600 dark:text-zinc-400">
              ...
              {activeFiltersCount > 0 && (
                <>
                  <span className="text-zinc-300 dark:text-zinc-700">•</span>
                  <span className="inline-flex items-center gap-1 text-blue-600 dark:text-blue-400 font-medium bg-blue-50/80 dark:bg-blue-950/60 px-2 py-0.5 rounded-md border border-blue-200/50 dark:border-blue-900/50 shadow-3xs hover-elevate">
        ...
        <div className="flex flex-wrap items-center gap-2 shrink-0">
          <Button
            ...
            className="gap-1.5 text-xs text-zinc-700 dark:text-zinc-300 border-zinc-200 dark:border-zinc-800 hover:bg-zinc-100 dark:hover:bg-zinc-800 hover-elevate cursor-pointer shadow-3xs"
          >
          ...
          <Button
            ...
            className="gap-1.5 text-xs bg-blue-600 hover:bg-blue-700 text-white shadow-xs hover-elevate cursor-pointer"
          >
